...
// }
//
// function checkEquivalentProperties(obj , sources) {
//     return Object.keys(sources).every(key => obj.hasOwnProperty(key) && obj[key] === sources[key]);
//
//
// }
//
// checkEquivalentProperties({name:"Muhammad Hasnain",age : 25, city : "Karachi"},
//     {name: "Muhammad Hasnain" , age : 25, city : "Karachi" , home: "malaria"});
